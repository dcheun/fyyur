...
def venues():
    ...
    # NOTE: data passed to the frontend should follow this format.
    # data = [{
    #     "city": "San Francisco",
    #     "state": "CA",
    #     "venues": [{
...
def show_venue(venue_id):
    ...
    # NOTE: data should be in the structure outlined below.
    # data1 = {
    #     "id": 1,
    #     "name": "The Musical Hop",
...
def show_artist(artist_id):
    ...
    # NOTE: data structure should follow example below.
    # data1 = {
    #     "id": 4,
    #     "name": "Guns N Petals",
    #     "genres": ["Rock n Roll"],
...
def edit_artist_submission(artist_id):
    try:
        ...
        db.session.rollback()
        flash(f'An error occurred. Artist {request.form.get("name", "UNKNOWN")} could not be updated.', 'danger')
        print(sys.exc_info())
    finally:
        db.session.close()
...
def edit_venue_submission(venue_id):
    try:
        ...
        db.session.rollback()
        flash(f'An error occurred. Venue {request.form.get("name", "UNKNOWN")} could not be updated.', 'danger')
        print(sys.exc_info())
    finally:
        db.session.close()
